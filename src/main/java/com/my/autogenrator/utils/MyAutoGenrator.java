...
public class MyAutoGenrator{
    private static final Logger logger = LoggerFactory.getLogger(MyAutoGenrator.class);
    ...
    public void execute() {
        ...
        // vo层
        config.getTableInfoList().stream().forEach(e -> e.setEntityName(e.getEntityName()+"Vo"));
        // 模板引擎初始化执行文件输出
    ...
    public MyAutoGenrator setCfg(InjectionConfig injectionConfig) {
